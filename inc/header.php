<nav id="nav-bar" class="navbar navbar-expand-lg navbar-light bg-white px-lg-4 py-lg-2 shadow-sm sticky-top">
    <div class="container-fluid">
        <a class="navbar-brand me-4 fw-bold fs-3 h-font d-flex align-items-center" href="index.php">
            <span class="text-dark"><?php echo $settings_r['site_title'] ?></span>
        </a>
...
<div class="btn-group">
  ...
  <ul class="dropdown-menu dropdown-menu-lg-end">
    ...
    <li><a class="dropdown-item" href="bookings.php"><i class="bi bi-calendar-check me-2"></i>Bookings</a></li>
        ...
        <div class="modal-content">
            <form id="login-form">
                ...
                <div class="modal-body">
                    <div class="mb-3">
                        <label class="form-label">Email/Name/Mobile</label>
                        <input type="text" name="email_name_mob" required class="form-control shadow-none">
        ...
        <div class="modal-content">
            <form id="forgot-form">
                ...
                <div class="modal-body">
                        ...
                        <div class="mb-4">
                            <label class="form-label">Name/Mobile</label>
                        <input type="text" name="name_mob" required class="form-control shadow-none">
                        </div>
                        <div class="mb-4">
                            <label class="form-label">Password</label>
                        <input type="text" name="pass" required class="form-control shadow-none">
                        </div>
