...
// NOTE:
// The project folder in your XAMPP/htdocs is named "Hotel" (capital H).
// On Linux this is case-sensitive, so the URL path must also use "Hotel"
// or image URLs like /hotel/images/... will 404.
